	...
	<body class="Adminbody">
		...
		<div class ="workArea">
			...
			<center>
				...
				<div class="TABLE2">
					<a href="AddPromos.php">
						<table>
							<tr><b> Add New Promotions </b></tr>
						</table>
					</a>
				</div>
				<br>
							...
							if( $result -> num_rows > 0 )
							{
							...
							
								{
									...
									echo "<tr>
											...
											<td><button type='submit'><a href='EditPromo.php?id=$id'>Edit</a></button></td>
											<td><button type='submit'><a href='DeletePromo.php?id=$id'>Delete</a></button></td>
											</tr>";
								}
							}
