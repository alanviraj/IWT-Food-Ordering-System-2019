			...
			<center>
				...
				<div class="TABLE2">
					<a href="AddCustomers.php">
						<table>
							<tr><b> Add New Customers </b></tr>
						</table>
					</a>
				</div>
				
				<div class="TABLE1">
					<a href="../Kovisha/src/deletecardDetails.php?phone=$phone">
						<table>
							<tr><b> Delete card Details </b></tr>
						</table>
					</a>
				</div>
				<br>
							...
							if( $result -> num_rows > 0 )
							{
							...
							
								{
									...
									echo "<tr>
											...
											<td>" .$row['Email']."</td> 
											<td>" .$row['feedBack']."</td>  
											<td><button type='submit'><a href='EditCustomers.php?id=$id'>Edit</a></button></td>
											<td><button type='submit'><a href='DeleteCustomers.php?id=$id'>Delete</a></button></td>
											</tr>";
								}
							}
