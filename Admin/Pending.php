			...
			<center>
				...
				<div class= "AdminTable">
					...
					<table border = "1" width ="100%">
						...
						<?php
							$sql = "SELECT * FROM customer_orders WHERE status ='Pending'";
							...
							if( $result -> num_rows > 0 )
							{
							...
							
								{
									...
									echo "<tr>
											...
											<td>" .$row['Phonecust']."</td> 
											<td>" .$row['status']."</td>   
											<td><button type='submit'><a href='EditPendingOrders.php?id=$id'>Edit</a></button></td>
											<td><button type='submit'><a href='DeletePendingOrders.php?id=$id'>Delete</a></button></td>
											</tr>";
